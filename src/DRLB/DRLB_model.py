...
class DRLB:
    def __init__(
        ...
        self.state_nums = config.feature_numbers
        ...
        self.memory_size = config.memory_size  # 记忆上限
        ...
        self.Q_memory = ReplayMemory(self.memory_size, config.seed)
    ...
    def learn_Q(self):
        ...
        state_batch, action_batch, reward_batch, next_state_batch, mask_batch = self.Q_memory.sample(batch_size=self.batch_size)
    ...
    def save(self, path):
        ...
        torch.save(self.q_eval.state_dict(), path + 'q_eval_net.pth')
    ...
    def load(self, path):
        self.q_eval.load_state_dict(torch.load(path + 'q_eval_net.pth'))
